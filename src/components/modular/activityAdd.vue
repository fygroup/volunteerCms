			...
			<div class="addFromListBox">
				<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
					...
					<el-form-item label="活动封面" prop="cover" class="form-control">
						<el-upload class="avatar-uploader" :action="serverUrl" :show-file-list="false" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload">
							<img v-if="ruleForm.cover" :src="ruleForm.cover" class="avatar">
							<i v-else class="el-icon-plus avatar-uploader-icon"></i>
						</el-upload>
					</el-form-item>
					<el-form-item label="活动时间" prop="activity_starttime" class="form-control">
						<el-date-picker v-model="ruleForm.activity_starttime" type="datetimerange" range-separator="至" start-placeholder="活动开始时间" end-placeholder="活动结束时间" value-format="yyyy-MM-dd HH:mm:ss" align="right">
						</el-date-picker>
					</el-form-item>
					<el-form-item label="报名时间" prop="sign_starttime" class="form-control">
						<el-date-picker v-model="ruleForm.sign_starttime" type="daterange" range-separator="至" start-placeholder="活动报名开始时间" end-placeholder="活动报名结束时间" value-format="yyyy-MM-dd" align="right">
						</el-date-picker>
					</el-form-item>
			...
			this.$refs[formName].validate(valid => {
				if (valid) {
					if(this.fileArr!=''){
                        ...
                        this.paramsList(this.ruleForm.cover);
                    }
				} else {
					return false;
				}
